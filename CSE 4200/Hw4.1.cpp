...
//    S[8].x = 1.0; S[1].y = 1.0;
//    S[9].x = 1.0; S[1].y = 1.0;
//    S[10].x = 1.0; S[1].y = 1.0;
//    S[11].x = 1.0; S[1].y = 1.0;
//
//    // Type 3 points
//    S[12].x = 1.0; S[2].y = -1.0;
//    S[13].x = 1.0; S[2].y = -1.0;
//    S[14].x = 1.0; S[2].y = -1.0;
//    S[15].x = 1.0; S[2].y = -1.0;
//    S[16].x = 1.0; S[2].y = -1.0;
//    S[17].x = 1.0; S[2].y = -1.0;
//
//    // Type 4 points
//    S[18].x = -1.0; S[3].y = -1.0;
//    S[19].x = -1.0; S[3].y = -1.0;
//    S[20].x = -1.0; S[3].y = -1.0;
//    S[21].x = -1.0; S[3].y = -1.0;
//    S[22].x = -1.0; S[3].y = -1.0;
//    S[23].x = -1.0; S[3].y = -1.0;
//
//    // Type 5 points
//    S[24].x = -1.0; S[4].y = 1.0;
//    S[25].x = -1.0; S[4].y = 1.0;
//    S[26].x = -1.0; S[4].y = 1.0;
//    S[27].x = -1.0; S[4].y = 1.0;
//    S[28].x = -1.0; S[4].y = 1.0;
